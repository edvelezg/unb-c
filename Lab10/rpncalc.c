...
/*
	...
	This function applies the operator to the top two elements on the operand stack.
	Because the elements on the stack are popped in reverse order, the right operand
	is popped before the left operand
	*/
	static void ApplyOperator(char op, stackADT operandStack){
...
/*
	...
	*/
	...
	static void HelpCommand(void){
		...
		printf("Enter expressions in Reverse Polish Notation (postfix)\n");
		...
		printf("    S -- Display all the values in the stack\n");
	}
...
/*
	...
	This function clears the stack by popping elements until it is empty.
*/
